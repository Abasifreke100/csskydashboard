  ...
  export const getCorporateSections = (data: Corporate): Section[] => {
    return [
      ...
      },
      {
        ...
        fields: [
          { label: "Name", value: data?.contact.nameOfContact },
          { label: "Designation", value: data?.contact.designation },
          { label: "Phone Number", value: data?.contact.phoneNumber },
      ...
      },
      {
        ...
        fields: [
          { label: "Director Name", value: data?.director.directorName },
          { label: "Director Designation", value: data?.director.designation },
          { label: "Director Phone Number", value: data?.director.phoneNumber },
          { label: "Director Email", value: data?.director.email },
          { label: "Director NIN", value: data?.director.nin?.toString() || "N/A" },
          // Add more fields as needed
        ],
      },
    ];
