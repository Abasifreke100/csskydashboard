...
interface SubsidiaryInsightBarChartState {
  barSize: number;
}
...
class SubsidiaryInsightBarChart extends PureComponent<{}, SubsidiaryInsightBarChartState> {
  constructor(props: {}) {
    super(props);
    this.state = {
...
export default SubsidiaryInsightBarChart;