...
const TicketDetailsModal = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onCloseModal}>
      <DialogContent className="font-poppins rounded-xl max-w-[380px] md:max-w-[450px] lg:max-w-md">
        <DialogTitle className="text-sm">Ticket ID #{ticket.id}</DialogTitle>
          <div className="flex flex-col gap-3 mt-3 text-xs">
            ...
            <p className="font-medium text-gray-400">
              Last Updated:{" "}<span className="text-black">{ticket.lastUpdated}</span>
            </p>
            <p className="font-medium text-gray-400">
                ...
                <div className="ml-1 ">
                  <div className="font-medium text-gray-400 text-sm whitespace-nowrap">
                   ...
                   <p className="text-xs text-black">{truncateText(ticket.assignee.name, 13)}</p>{" "}
                    ...
                    <p className="text-[10px]">{truncateText(ticket.assignee.comments, 30)}</p>
                  </div>
